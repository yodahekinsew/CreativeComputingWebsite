...
class ModuleLayout extends Component {
  render() {
    return (
      <div style={{display:'flex', flexDirection:'column', position:'absolute', justifyContent:'space-around', height:'100%', minHeight:'800px', width:'100%', minWidth:'1000px', backgroundColor:'whitesmoke'}}>
